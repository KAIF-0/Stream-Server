...
const createFFmpegProcess = async (userId, streamKey) => {
  ...
  const options = [ "-re", // Read input at native frame rate 
                   ...
                   // Changed from ultrafast for better quality 
                   "-tune", "zerolatency", 
                   "-r", "25", 
                   
                   // Frame rate 
                   "-g", "50", // GOP size (2 seconds) 
                   "-keyint_min", "25", "-crf", "23", 
                   
                   // Better quality (lower = better) 
                   "-pix_fmt", "yuv420p", 
                   "-sc_threshold", "0", 
                   "-profile:v", "high", 
                   
                   // Changed to high for better quality 
